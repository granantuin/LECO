...
st.set_page_config(page_title="A Coruña airport Machine Learning forecast",layout="wide")
...
alg = pickle.load(open("algorithms/dir_LECO_d0.al","rb"))
alg1 = pickle.load(open("algorithms/dir_LECO_d1.al","rb"))
...
#open algorithm spd d0 d1
alg = pickle.load(open("algorithms/spd_LECO_d0.al","rb"))
alg1 = pickle.load(open("algorithms/spd_LECO_d1.al","rb"))
...
alg = pickle.load(open("algorithms/brfg_LECO_d0.al","rb"))
alg1 = pickle.load(open("algorithms/brfg_LECO_d1.al","rb"))
...
#@title Precipitation
#open algorithm prec d0 d1
alg = pickle.load(open("algorithms/prec_LECO_d0.al","rb"))
alg1 = pickle.load(open("algorithms/prec_LECO_d1.al","rb"))
...
plt.grid(True,axis="both")
plt.title("Actual Heidke skill score meteorological model: {}. Reference: 0.25\nActual Heidke skill score machine learning: {}. Reference: 0.40".format(HSS_wrf,HSS_ml))
st.pyplot(fig)
...
alg = pickle.load(open("algorithms/vis_LECO_d0.al","rb"))
alg1 = pickle.load(open("algorithms/vis_LECO_d1.al","rb"))
...
plt.grid(True, axis="both")
plt.title("Actual Heidke skill score meteorological model: {}. Reference: 0.08\nActual Heidke skill score machine learning: {}. Reference: 0.43".format(HSS_wrf,HSS_ml))
st.pyplot(fig)
...
alg = pickle.load(open("algorithms/temp_LECO_d0.al","rb"))
alg1 = pickle.load(open("algorithms/temp_LECO_d1.al","rb"))
...
title = "Actual mean absolute error meteorological model: {}. Reference: 1.5\nActual mean absolute error machine learning: {}. Reference: 0.95".format(mae_wrf,mae_ml)
ax.set_title(title)
ax.grid(True, which = "both", axis = "both")
st.pyplot(fig)
...
#open algorithm temperature d0 d1
alg = pickle.load(open("algorithms/pres_LECO_d0.al","rb"))
alg1 = pickle.load(open("algorithms/pres_LECO_d1.al","rb"))
